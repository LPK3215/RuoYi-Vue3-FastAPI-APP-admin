...
class ToolSoftwareCategoryModel(BaseModel):
    """
    软件分类表对应pydantic模型
    """
...
class ToolSoftwareCategoryQueryModel(ToolSoftwareCategoryModel):
    """
    软件分类不分页查询模型
    """


class ToolSoftwareCategoryPageQueryModel(ToolSoftwareCategoryQueryModel):
    """
    软件分类分页查询模型
    """
...
class DeleteToolSoftwareCategoryModel(BaseModel):
    """
    删除软件分类模型
    """
...
class ToolSoftwareCategoryOptionModel(BaseModel):
    """
    软件分类下拉选项模型
    """
